...
***
# **Types of migration **
## *Regional perspective: International migration*
```{r, echo = FALSE, results="asis"} 
bib[c("mayda2010international","hanson2010great")]
```  

## *Regional perspective: Internal migration & Urbanization*
```{r, echo = FALSE, results="asis"} 
bib[c("greenwood1997internal","johnson2017frozen","flippen2013relative","hall2015neighborhood","clark1991residential","davis1955origin")]
``` 

## *Refugees* 
Note: Really need to go over papers here.

```{r, echo = FALSE, results="asis"} 
bib[c("lee2002enforcing","ngai2003strange","de2004legal","menjivar2006liminal","hamlin2012symbolic","nevins2002operation","de2002migrant")]

```  

## *Forced migration*
```{r, echo = FALSE, results="asis"} 
bib[c("neumayer2004asylum","riosmena2018climate","schon2019motivation","zolberg1986international","nwokeji2001african","horowitz1991victims")]
```

***
# **Who remains? Integration/Assimilation**
```{r, echo = FALSE, results="asis"} 
bib[c("gordon1964assimilatio","alba2009remaking","kasinitz2009inheriting","perlmann2005italians","alba2014mexican","lee2015asian","brown2006assimilation")]
```
...
```{r, echo = FALSE, results="asis"} 
bib[c("donato2011we","massey2016border","amuedo2014intended")]
```
***
